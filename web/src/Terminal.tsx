...
export function Terminal({
  ...
  useEffect(() => {
    ...
    // Optional addons — must load AFTER open() so activate() runs inside
    // the try-catch (before open(), loadAddon only registers; activate()
    // fires during open() and escapes the try-catch).
