 ...
 * self-contained vault (fresh ed25519 + IDEALAB_API_KEY from env), and both
 ...
 * podman / IDEALAB_API_KEY / FIRST_RUN_AI_BASE_URL missing -> FAIL, never skip.
 *
...
requireEnv("IDEALAB_API_KEY", "export it before running (real AI needs a real key; we never read it from disk)");
requireEnv(
